...
if (isset($_GET['id_bahan'])) {
  $id = ($_GET['id_bahan']);
  $result = readQuery('bahan', 'id_bahan', $id);
    ...
    <section id="edit-menu" class="about">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
          <br>
          <p>Edit<span> Bahan </span></p>
        </div>
        <div class="gradient-custom-1 h-100">
          <div class="mask d-flex align-items-center h-100">
            <div class="container">
              <form action="#" method="POST" id="form-add" enctype="multipart/form-data">
                <input type="hidden" name="id_bahan" id="id_bahan" value="<?= $data['id_bahan'] ?>">
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="stok_bahan" name="stok_bahan"
                    value="<?= $data['stok_bahan'] ?>" required>
                </div>
                <div class="mb-3">
                  <label for="harga_bahan" class="form-label">Harga</label>
                  <input type="text" class="form-control" id="harga_bahan" name="harga_bahan"
                    value="<?= $data['harga_bahan'] ?>" required>
                </div>
                <a href="admin.php"><button type="button" class="btn btn-secondary"
                    data-bs-dismiss="modal">Cancel</button></a>
                <button type="submit" class="btn btn-info text-white" name="edit-bahan" id="edit-bahan"
                  form="form-add">Update Bahan</button>
              </form>

    ...
    <section id="add-menu" class="about">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
          <br>
          <p>Tambah<span> Menu </span>Baru</p>
        </div>
          ...
          <div class="mask d-flex align-items-center h-100">
            <div class="container">
              <form action="#" method="POST" id="form-add" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                  <label for="foto_makanan" class="form-label">Foto</label>
                  <input class="form-control" type="file" id="foto_makanan" name="foto_makanan" required>
                </div>
                <div class="mb-3">
                  ...
                  <div class="container">
                    <div class="row g-0">
                      ...
                      foreach ($listBahan as $bahan) { ?>
                        <div class="col-md-3">
                          <input type="checkbox" name="bahan[]" value="<?= $bahan['id_bahan'] ?>">
                          <label>
                            <?= $bahan['nama_bahan'] ?>
                          </label>
                        </div>
                ...
                <button type="submit" class="btn btn-info text-white" name="btn-add" id="btn-add"
                  form="form-add">Tambahkan Menu</button>
              </form>

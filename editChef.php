...
if (isset($_GET['id_chef'])) {
  $id = ($_GET["id_chef"]);
  $result = readQuery('chef', 'id_chef', $id);
    ...
    <section id="edit-menu" class="about">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
          <br>
          <p>Edit<span> Chef </span></p>
        </div>
        <div class="gradient-custom-1 h-100">
          <div class="mask d-flex align-items-center h-100">
            <div class="container">
              <form action="#" method="POST" id="form-add" enctype="multipart/form-data">
                <input type="hidden" name="id_chef" id="id_chef" value="<?= $data['id_chef'] ?>">
                <div class="mb-3">
                  <img src="assets/img/<?= $data['foto_chef'] ?>" alt="" width="300" height="300">
                  <br>
                  <label for="foto_chef" class="form-label">Abaikan Jika tidak mengganti foto</label>
                  <input class="form-control" type="file" id="foto_chef" name="foto_chef">
                </div>
                <div class="mb-3">
                  <label for="nama_chef" class="form-label">Nama Menu</label>
                  <input type="text" class="form-control" id="nama_chef" name="nama_chef"
                    value="<?= $data['nama_chef'] ?>" required>
                </div>
                <div class="mb-3">
                  <label for="no_telp_chef" class="form-label">No Telp Chef</label>
                  <input type="text" class="form-control" id="no_telp_chef" name="no_telp_chef"
                    value="<?= $data['no_telp_chef'] ?>" required>
                </div>
                <div class="mb-3">
                  <label for="alamat_chef" class="form-label">Alamat Chef</label>
                  <input type="text" class="form-control" id="alamat_chef" name="alamat_chef"
                    value="<?= $data['alamat_chef'] ?>" required>
                </div>
                <div class="mb-3">
                ...
                <button type="submit" class="btn btn-info text-white" name="edit-chef" id="edit-chef"
